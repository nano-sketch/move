<script lang="ts">
  ...
  import marketingImg from "../sort/marketing.png";
  import webdevImg from "../sort/webdev.png";
  import performanceImg from "../sort/performance.png";
...
<main class="select-none bg-background text-foreground">
  <!-- hero section -->
  <section
  ...
  <!-- about us / services detail section -->
  ...
  >
    ...
    <div class="relative z-10 mx-auto max-w-screen-xl px-6">
      ...
      <div class="grid md:grid-cols-2 gap-8">
        {#each project_data as project (project.title)}
          <a
            href={project.url}
            target="_blank"
  ...
  <footer class="py-12 border-t border-border mt-32">
    <div
      class="mx-auto max-w-screen-xl px-6 flex flex-col sm:flex-row justify-between items-center gap-8"
    >
      ...
      <p class="text-xs text-muted-foreground font-medium">
        © 2026 MOVE AGENCY. ALL RIGHTS RESERVED.
      </p>
    </div>
  </footer>
</main>
