...
>
  ...
  <span
    class="backdrop absolute inset-px rounded-[11px] bg-primary/20 transition-colors duration-200 group-hover:bg-primary/30"
  />
  <span class="z-10 text-primary-foreground text-sm font-medium">
    <slot>Button</slot>
  </span>
</button>
