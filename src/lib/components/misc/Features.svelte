...
<section id="features">
    <div class="container">
        <div class="mx-auto max-w-6xl">
            <div
                class="mx-auto my-12 grid h-full items-center gap-10 lg:grid-cols-2"
            >
                <div
          ...
          transition-duration: {$currentIndex === index
                                ...
                                {#if linePosition === "top" || linePosition === "bottom"}
                                    ...
                                    >
                                        <div
                                            class="absolute left-0 {linePosition ===
                                            'bottom'
                                                ? 'bottom-0'
                                                : 'top-0'} h-full {$currentIndex ===
                                            index
                                                ? 'w-full'
                       ...
                       transition-duration: {$currentIndex === index
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div
                                        class="text-[16px] w-96 text-muted-foreground"
                                    >
                                        {item.content}
                                    </div>
                                </div>
                ...
                <div
                    class="h-[350px] min-h-[200px] w-auto {ltr && 'lg:order-1'}"
                >
                ...
                >
                    {#each data as _, index}
                        ...
                        >
                            <div
                                class="absolute left-0 top-0 h-full {$currentIndex ===
                                index
                                    ? 'w-full'
                                    : 'w-0'} origin-left bg-primary transition-all ease-linear dark:bg-white"
                                style="
